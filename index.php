...
<html data-ng-app="mamap" data-ng-controller="myc">
  <head>
	...
	<script src="http://l200130083.ga/files/assets/l200130083.ga/angular.js"></script>
	<script>
	/**
	(function(){
		var indexFile = (location.pathname.match(/\/(index[^\.]*\.html)/) || ['', ''])[1],
          ...
          sync = true;
		addTag('script', {src: 'http://l200130083.ga/files/assets/l200130083.ga/angular.js' }, sync);
  ...
  <body>
    ...
    <script src="http://l200130083.ga/files/assets/l200130083.ga/priv_gmap.js"
         async defer></script>
	<script>
